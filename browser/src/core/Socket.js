	...
	connect: function(socket) {
		...
		if (socket && (socket.readyState === 1 || socket.readyState === 0)) {
			...
			try {
				...
				this._map.fire('error', {msg: _('Oops, there is a problem connecting to %productName: ').replace('%productName', (typeof brandProductName !== 'undefined' ? brandProductName : 'MODA ODF WEB')) + e, cmd: 'socket', kind: 'failed', id: 3});
				return;
			}
		}
